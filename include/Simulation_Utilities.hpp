...
{
// The distant sampling sphere only represents the asymptotic incident flux.
// It does not define the domain of a captured solar orbit.
constexpr double INCIDENT_SAMPLING_RADIUS_AU = 1100.0;
...
extern Event Initial_Conditions(obscura::DM_Distribution& halo_model, Solar_Model& model, std::mt19937& PRNG,
                                double outer_boundary_radius = INCIDENT_SAMPLING_RADIUS_AU * libphysica::natural_units::AU);
