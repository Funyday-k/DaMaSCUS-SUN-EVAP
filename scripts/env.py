...
def build_parser():
    parser = argparse.ArgumentParser(
        description="Run SD baseline constant-cross-section capture calculation."
    )
    ...
    parser.add_argument(
        ...
        choices=["verified_only", "include_placeholders"],
        help="Which SD isotope set to build into earth_data."
    )
    ...
    parser.add_argument(
        "--output-root",
        type=str,
        default=os.path.join(BASE_DIR, "outputs", "sd_baseline_constant"),
