#!/usr/bin/run_sd_operator_comparison python3
import os
import sys
import argparse
import numpy as np
...
def build_parser():
    parser = argparse.ArgumentParser(
        description="Run verified-only SD operator comparison at T=0."
    )
    ...
    parser.add_argument(
        "--output-root",
        type=str,
        default=os.path.join(BASE_DIR, "outputs", "sd_operator_comparison"),
...
def main():
    ...
    print("=" * 80)
    print("Verified-only SD operator comparison runner")
    print("=" * 80)
    ...
    results = pt.plot_verified_only_sd_operator_comparison(
